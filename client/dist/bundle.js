...
var ChirpForm = function (_Component) {
    _inherits(ChirpForm, _Component);
    ...
    _createClass(ChirpForm, [{
        ...
        value: function handleInputChange(chirp) {
            this.setState({ chirp: chirp });
        }
    }, {
        key: 'render',
                ...
                _react2.default.createElement(
                    'button',
                    {
                        onClick: function onClick() {
                            _this2.props.postChirp(_this2.state.chirp);
                        },
                        type: 'button',
...
var _chirps = __webpack_require__(82);
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/', component: _chirps2.default }),
...
var _chirpForm = __webpack_require__(35);

var _chirpForm2 = _interopRequireDefault(_chirpForm);

var _chirpList = __webpack_require__(83);
...
var Chirps = function (_Component) {
    _inherits(Chirps, _Component);

    function Chirps(props) {
        _classCallCheck(this, Chirps);

        var _this = _possibleConstructorReturn(this, (Chirps.__proto__ || Object.getPrototypeOf(Chirps)).call(this, props));
    ...
    _createClass(Chirps, [{
        ...
        value: function getChirps() {
            ...
            fetch('/api/chirps/').then(function (response) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'container' },
                _react2.default.createElement(_chirpForm2.default, { postChirp: function postChirp(text) {
                        _this4.addChirp(text);
                    } }),
...
var _chirp = __webpack_require__(84);
...
var ChirpList = function (_Component) {
    _inherits(ChirpList, _Component);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.props.chirps.map(function (chirp) {
                    return _react2.default.createElement(_chirp2.default, { key: chirp.id, text: chirp.text, index: chirp.id });
                })
            );
        }
    }]);
...
var _detailButton = __webpack_require__(85);

var _detailButton2 = _interopRequireDefault(_detailButton);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Chirp = function Chirp(props) {
    return _react2.default.createElement(
        'div',
        { className: 'card m-1' },
        _react2.default.createElement(
            ...
            _react2.default.createElement(_detailButton2.default, { id: props.index })
        )
    );
};
...
var DetailButton = function DetailButton(props) {
    return _react2.default.createElement(
        'button',
        { id: props.id },
        _react2.default.createElement(
...
var Details = function (_Component) {
    ...
    _createClass(Details, [{
        ...
        key: 'updateChirp',
        value: function updateChirp(text) {
            var _this3 = this;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'container' },
                this.state.chirps.map(function (chirp) {
                    //console.log(chirp.id);
                    if (chirp.id == _this5.props.match.params.id) {
                        return _react2.default.createElement(
                            'div',
                            { key: chirp.id, className: 'card m-1' },
                            _react2.default.createElement(
                                'div',
                                { className: 'card-body text-left' },
                                _react2.default.createElement(
